...
const FALLBACK_PROJECTS: Project[] = [
  { _id: 'p1', title: 'Sales Analytics Dashboard', description: 'Built an end-to-end Power BI dashboard tracking $12M in revenue across 6 regions, reducing reporting time by 70%.', tools: ['Power BI', 'SQL', 'Python'], category: 'Dashboard', featured: true },
  { _id: 'p2', title: 'Customer Churn Predictor', description: 'ML model achieving 91% accuracy in predicting customer churn, enabling proactive retention campaigns.', tools: ['Python', 'Scikit-learn', 'Pandas'], category: 'Machine Learning', featured: true },
  { _id: 'p3', title: 'E-Commerce ETL Pipeline', description: 'Automated data pipeline processing 500K+ rows daily from 4 sources into a unified data warehouse.', tools: ['Python', 'PostgreSQL', 'Airflow'], category: 'Data Analysis' },
  { _id: 'p4', title: 'Financial Risk Model', description: 'Statistical risk assessment model for loan default prediction with 88% precision using ensemble methods.', tools: ['Python', 'R', 'Excel'], category: 'Machine Learning' },
  { _id: 'p5', title: 'HR Analytics Platform', description: 'Comprehensive workforce analytics with attrition analysis, performance prediction, and headcount planning.', tools: ['Power BI', 'DAX', 'SQL'], category: 'Dashboard' },
  { _id: 'p6', title: 'Market Basket Analysis', description: 'Association rule mining on 2M transactions revealing cross-sell opportunities worth $450K annually.', tools: ['Python', 'Pandas', 'Matplotlib'], category: 'Data Analysis' },
]
